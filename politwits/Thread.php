...
class Thread {
     ...
     */
    public function __construct( $scope, $_runnable = null ) {
    	if( $_runnable !== null ) {
            $this->scope=$scope;
    ...
    public function runnableOk( $_runnable ) {
        ...
        return ( method_exists( $this->getScope(), $_runnable ) && is_callable( array($this->getScope(), $_runnable )) );
    ...
    public function start() {
        ...
        if( $pid ) {
            ...
            if ( !empty( $arguments ) ) {
                call_user_func_array( array($this->getScope(), $this->runnable), $arguments );
            }
            else {
                call_user_func( array($this->getScope(), $this->runnable) );
            }
