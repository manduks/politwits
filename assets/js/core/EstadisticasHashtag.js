            ...
            '<table class="table table-striped">',
                '<thead>',
                    '<tr>',
                        ...
                        '<th><div style="text-align: center;" title="Porcentaje de relacion entre usuarios unicos y total">%</div></th>',
                    '</tr>',
                '</thead>',
                '<tbody>',
                    '<tpl for=".">',
                        '<tr>',
                            ...
                            '<td><div style="text-align: center;" title="Porcentaje de relacion entre usuarios unicos y total">',
